...
<body>
		...
		<div class="w3-bar w3-white w3-padding w3-card"
			...
			<div style="margin-left: 35%">
				<div class="w3-left w3-hide-small">
					<a href="${path}/model2/board/list.bo?type=1" class="w3-bar-item w3-button w3-margin-left">
						여행지 추천 리뷰 </a> <a href="${path}/model2/board/list2.bo?type=2"
						class="w3-bar-item w3-button w3-margin-left"> 동행자 모집 </a> <a
						href="${path}/model2/board/list3.bo?type=3" class="w3-bar-item w3-button w3-margin-left">
						회원 질문 답변 </a>
				</div>
			</div>
		</div>
	...
	<header class="w3-display-container w3-content w3-wide"
		style="max-width: 1500px; min-width: 1000px; margin-top: 100px; max-height: 650px; min-height: 400px;" id="home">
		<img src="${path}/images/travel.png" alt="Hamburger Catering" width="100%">
	...
	<footer class="w3-center w3-light-grey w3-padding-32">
		...
		<div class="w3-center w3-padding-32">
			상호명: Travel maker | 대표자: 신지호 | 전화: 010-3412-0161 | 사업자등록번호: 457-85-00300<br>주소: (우)08505 서울시 금천구 가산디지털2로 115, 509호,
			811호 (가산동, 대륭테크노타운 3차) | 통신판매업신고번호: 제 2014-서울금천-0864 호<br> 홈페이지
			제작자: 신지호 | <a href="#">jhhj424@naver.com</a> | Copyright(C) 2015
			GooDee ALL Right Reserved.
		</div>
	</footer>
</body>
</html>
