	...
	<table border="1" style="border-collapse: collapse; width: 100%" class="table14_11">
						...
						<%-- empty : b.file1 == null || b.file1 == ""  --%> <c:if
							...
							<c:if test="${!empty login}">
								<a href="file/${b.file1 }" style="text-decoration: none;"> <img
									src="${path}/file.PNG" width=15 height=15></a>
							</c:if>
							<%-- @</a> -->
		<%-- @</a>  =>  <img src ="file/file.PNG" width=15 height=15></a> --%>
					...
					info.jsp에 해당 내용을 출력하기 --%> <a
						href="info.bo?num=${b.num}&type=${b.type}"
		...
		<tr>
			<td colspan="5">
				<button type="button" onclick="location.href='writeForm.bo' "
		...
		<tr>
			<td colspan="5" align="right">
				<form action="list.bo" method="post" name="sf">
					<input  type="hidden" name="pageNum" value="1">게시글 검색: <input
						type="hidden" name="type" value="1"> <select name="column">
